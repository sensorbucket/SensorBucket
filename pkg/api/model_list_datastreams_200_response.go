...
// checks if the ListDatastreams200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListDatastreams200Response{}
...
func (o ListDatastreams200Response) ToMap() (map[string]interface{}, error) {
