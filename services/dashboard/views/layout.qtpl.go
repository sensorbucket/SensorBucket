...
var navItems = []NavItem{
	...
	{Label: "Workers", URL: "/workers", Icon: "mdi:latest"},
}

//line services/dashboard/views/layout.qtpl:16
type Page interface {
//line services/dashboard/views/layout.qtpl:16
	Title() string
//line services/dashboard/views/layout.qtpl:16
...
//line services/dashboard/views/layout.qtpl:25
...
//line services/dashboard/views/layout.qtpl:31
...
//line services/dashboard/views/layout.qtpl:33
...
<head>
    ...
    `)
//line services/dashboard/views/layout.qtpl:42
...
//line services/dashboard/views/layout.qtpl:42
    ...
    `)
//line services/dashboard/views/layout.qtpl:55
...
//line services/dashboard/views/layout.qtpl:74
		qw422016.N().S(`
                <li>
                    <a href="`)
//line services/dashboard/views/layout.qtpl:76
...
//line services/dashboard/views/layout.qtpl:76
		qw422016.N().S(`"
                        ...
                        <iconify-icon icon="`)
//line services/dashboard/views/layout.qtpl:78
		qw422016.E().S(item.Icon)
//line services/dashboard/views/layout.qtpl:78
		qw422016.N().S(`" width="24" class="pr-4 w-8"></iconify-icon>
                        <span>
                            `)
//line services/dashboard/views/layout.qtpl:80
...
//line services/dashboard/views/layout.qtpl:84
    ...
    <section class="flex-1 mt-12 lg:mt-0 lg:ml-sidebar" id="main-wrapper">
        ...
        <main class="p-4 pt-0 mt-4" id="main">
            `)
//line services/dashboard/views/layout.qtpl:93
...
//line services/dashboard/views/layout.qtpl:93
    ...
    `)
//line services/dashboard/views/layout.qtpl:97
...
`)
//line services/dashboard/views/layout.qtpl:111
}
