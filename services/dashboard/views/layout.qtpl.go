...
//line services/dashboard/views/layout.qtpl:42
    ...
    `)
//line services/dashboard/views/layout.qtpl:56
...
//line services/dashboard/views/layout.qtpl:79
		qw422016.N().S(`" width="24" class="pr-4 w-8"></iconify-icon>
                        <span>
                            `)
//line services/dashboard/views/layout.qtpl:81
...
//line services/dashboard/views/layout.qtpl:81
		qw422016.N().S(`
                ...
                `)
//line services/dashboard/views/layout.qtpl:85
	}
//line services/dashboard/views/layout.qtpl:85
	qw422016.N().S(`
            </ul>
    ...
    <section class="flex-1 mt-12 lg:mt-0 lg:ml-sidebar" id="main-wrapper">
        ...
        <main class="p-4 pt-0 mt-4" id="main">
            `)
//line services/dashboard/views/layout.qtpl:94
...
//line services/dashboard/views/layout.qtpl:94
    ...
    `)
//line services/dashboard/views/layout.qtpl:98
...
`)
//line services/dashboard/views/layout.qtpl:102
}
...
//line services/dashboard/views/layout.qtpl:106
...
`)
//line services/dashboard/views/layout.qtpl:112
}
