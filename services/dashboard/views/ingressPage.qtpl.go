...
//line services/dashboard/views/ingressPage.qtpl:38
				qw422016.N().S(`
                         border-emerald-500
                        `)
//line services/dashboard/views/ingressPage.qtpl:40
			case 4:
//line services/dashboard/views/ingressPage.qtpl:40
				qw422016.N().S(`
                         border-orange-500
...
//line services/dashboard/views/ingressPage.qtpl:42
				qw422016.N().S(`
                         border-rose-500
                        `)
//line services/dashboard/views/ingressPage.qtpl:44
			default:
//line services/dashboard/views/ingressPage.qtpl:44
				qw422016.N().S(`
                        `)
...
//line services/dashboard/views/ingressPage.qtpl:55
				qw422016.N().S(`
                        ...
                        `)
//line services/dashboard/views/ingressPage.qtpl:57
			}
//line services/dashboard/views/ingressPage.qtpl:57
			qw422016.N().S(`
                        `)
...
//line services/dashboard/views/ingressPage.qtpl:58
				qw422016.N().S(`
                        ...
                        ">
                            `)
//line services/dashboard/views/ingressPage.qtpl:63
...
//line services/dashboard/views/ingressPage.qtpl:65
			qw422016.N().S(`
                ...
                `)
//line services/dashboard/views/ingressPage.qtpl:67
		}
//line services/dashboard/views/ingressPage.qtpl:67
		qw422016.N().S(`
            </ul>
...
`)
//line services/dashboard/views/ingressPage.qtpl:72
	}
//line services/dashboard/views/ingressPage.qtpl:72
	qw422016.N().S(`
`)
//line services/dashboard/views/ingressPage.qtpl:73
}
...
//line services/dashboard/views/ingressPage.qtpl:76
