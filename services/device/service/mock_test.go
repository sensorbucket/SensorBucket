...
//			},
//			ListFunc: func(deviceFilter service.DeviceFilter, request pagination.Request) (*pagination.Page[Device], error) {
//				panic("mock out the List method")
//			},
//			ListInBoundingBoxFunc: func(deviceFilter service.DeviceFilter, request pagination.Request) (*pagination.Page[Device], error) {
//				panic("mock out the ListInBoundingBox method")
//			},
//			ListInRangeFunc: func(deviceFilter service.DeviceFilter, request pagination.Request) (*pagination.Page[Device], error) {
//				panic("mock out the ListInRange method")
//			},
//			ListSensorsFunc: func(request pagination.Request) (*pagination.Page[Sensor], error) {
...
// List calls ListFunc.
func (mock *StoreMock) List(deviceFilter service.DeviceFilter, request pagination.Request) (*pagination.Page[Device], error) {
...
func (mock *StoreMock) ListInBoundingBox(deviceFilter service.DeviceFilter, request pagination.Request) (*pagination.Page[Device], error) {
...
func (mock *StoreMock) ListInRange(deviceFilter service.DeviceFilter, request pagination.Request) (*pagination.Page[Device], error) {
...
func (mock *StoreMock) ListSensors(request pagination.Request) (*pagination.Page[Sensor], error) {
...
//			AddSensorFunc: func(ctx context.Context, dev *service.Device, dto service.NewSensorDTO) error {
...
//			},
//			ListDevicesFunc: func(ctx context.Context, filter service.DeviceFilter, r pagination.Request) (*pagination.Page[Device], error) {
//				panic("mock out the ListDevices method")
//			},
//			ListSensorsFunc: func(ctx context.Context, r pagination.Request) (*pagination.Page[Sensor], error) {
//				panic("mock out the ListSensors method")
//			},
...
func (mock *ServiceMock) AddSensor(ctx context.Context, dev *service.Device, dto service.NewSensorDTO) error {
...
func (mock *ServiceMock) ListDevices(ctx context.Context, filter service.DeviceFilter, r pagination.Request) (*pagination.Page[Device], error) {
...
// ListSensors calls ListSensorsFunc.
func (mock *ServiceMock) ListSensors(ctx context.Context, r pagination.Request) (*pagination.Page[Sensor], error) {
	if mock.ListSensorsFunc == nil {
