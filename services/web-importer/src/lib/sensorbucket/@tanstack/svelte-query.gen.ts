...
import { type Options, listDevices, createDevice, deleteDevice, getDevice, updateDevice, listDeviceSensors, createDeviceSensor, deleteDeviceSensor, getSensor, updateSensor, listSensors, listFeaturesOfInterest, createFeatureOfInterest, deleteFeatureOfInterest, getFeatureOfInterest, updateFeatureOfInterest, queryMeasurements, listDatastreams, getDatastream, listPipelines, createPipeline, disablePipeline, getPipeline, updatePipeline, processUplinkData, listTraces, listWorkers, createWorker, getWorker, updateWorker, getWorkerUserCode, listTenants, addTenantMember, removeTenantMember, updateTenantMember, listApiKeys, createApiKey, revokeApiKey, getApiKey } from '../sdk.gen';
...
export const listFeaturesOfInterestQueryKey = (options?: Options<ListFeaturesOfInterestData>) => createQueryKey('listFeaturesOfInterest', options);

export const listFeaturesOfInterestOptions = (options?: Options<ListFeaturesOfInterestData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await listFeaturesOfInterest({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: listFeaturesOfInterestQueryKey(options)
    });
};

export const listFeaturesOfInterestInfiniteQueryKey = (options?: Options<ListFeaturesOfInterestData>): QueryKey<Options<ListFeaturesOfInterestData>> => createQueryKey('listFeaturesOfInterest', options, true);

export const listFeaturesOfInterestInfiniteOptions = (options?: Options<ListFeaturesOfInterestData>) => {
    return infiniteQueryOptions<ListFeaturesOfInterestResponse, DefaultError, InfiniteData<ListFeaturesOfInterestResponse>, QueryKey<Options<ListFeaturesOfInterestData>>, string | Pick<QueryKey<Options<ListFeaturesOfInterestData>>[0], 'body' | 'headers' | 'path' | 'query'>>(
    // @ts-ignore
    {
        queryFn: async ({ pageParam, queryKey, signal }) => {
            // @ts-ignore
            const page: Pick<QueryKey<Options<ListFeaturesOfInterestData>>[0], 'body' | 'headers' | 'path' | 'query'> = typeof pageParam === 'object' ? pageParam : {
                query: {
                    cursor: pageParam
                }
            };
        ...
        queryKey: listFeaturesOfInterestInfiniteQueryKey(options)
    });
};

export const createFeatureOfInterestQueryKey = (options?: Options<CreateFeatureOfInterestData>) => createQueryKey('createFeatureOfInterest', options);

export const createFeatureOfInterestOptions = (options?: Options<CreateFeatureOfInterestData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await createFeatureOfInterest({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: createFeatureOfInterestQueryKey(options)
    });
};

export const createFeatureOfInterestMutation = (options?: Partial<Options<CreateFeatureOfInterestData>>) => {
    const mutationOptions: MutationOptions<CreateFeatureOfInterestResponse, DefaultError, Options<CreateFeatureOfInterestData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await createFeatureOfInterest({
                ...options,
                ...localOptions,
...
export const deleteFeatureOfInterestMutation = (options?: Partial<Options<DeleteFeatureOfInterestData>>) => {
    const mutationOptions: MutationOptions<unknown, DefaultError, Options<DeleteFeatureOfInterestData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await deleteFeatureOfInterest({
                ...options,
                ...localOptions,
                throwOnError: true
            });
...
export const getFeatureOfInterestQueryKey = (options: Options<GetFeatureOfInterestData>) => createQueryKey('getFeatureOfInterest', options);

export const getFeatureOfInterestOptions = (options: Options<GetFeatureOfInterestData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await getFeatureOfInterest({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: getFeatureOfInterestQueryKey(options)
    });
};

export const updateFeatureOfInterestMutation = (options?: Partial<Options<UpdateFeatureOfInterestData>>) => {
    const mutationOptions: MutationOptions<UpdateFeatureOfInterestResponse, DefaultError, Options<UpdateFeatureOfInterestData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await updateFeatureOfInterest({
                ...options,
                ...localOptions,
                throwOnError: true
            });
