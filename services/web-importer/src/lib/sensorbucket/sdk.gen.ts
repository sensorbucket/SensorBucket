...
import type { AddTenantMemberData, AddTenantMemberErrors, AddTenantMemberResponses, CreateApiKeyData, CreateApiKeyErrors, CreateApiKeyResponses, CreateDeviceData, CreateDeviceErrors, CreateDeviceResponses, CreateDeviceSensorData, CreateDeviceSensorErrors, CreateDeviceSensorResponses, CreateFeatureOfInterestData, CreateFeatureOfInterestErrors, CreateFeatureOfInterestResponses, CreatePipelineData, CreatePipelineErrors, CreatePipelineResponses, CreateWorkerData, CreateWorkerResponses, DeleteDeviceData, DeleteDeviceErrors, DeleteDeviceResponses, DeleteDeviceSensorData, DeleteDeviceSensorErrors, DeleteDeviceSensorResponses, DeleteFeatureOfInterestData, DeleteFeatureOfInterestErrors, DeleteFeatureOfInterestResponses, DisablePipelineData, DisablePipelineErrors, DisablePipelineResponses, GetApiKeyData, GetApiKeyErrors, GetApiKeyResponses, GetDatastreamData, GetDatastreamErrors, GetDatastreamResponses, GetDeviceData, GetDeviceErrors, GetDeviceResponses, GetFeatureOfInterestData, GetFeatureOfInterestErrors, GetFeatureOfInterestResponses, GetPipelineData, GetPipelineErrors, GetPipelineResponses, GetSensorData, GetSensorErrors, GetSensorResponses, GetWorkerData, GetWorkerErrors, GetWorkerResponses, GetWorkerUserCodeData, GetWorkerUserCodeErrors, GetWorkerUserCodeResponses, ListApiKeysData, ListApiKeysErrors, ListApiKeysResponses, ListDatastreamsData, ListDatastreamsErrors, ListDatastreamsResponses, ListDevicesData, ListDeviceSensorsData, ListDeviceSensorsErrors, ListDeviceSensorsResponses, ListDevicesErrors, ListDevicesResponses, ListFeaturesOfInterestData, ListFeaturesOfInterestErrors, ListFeaturesOfInterestResponses, ListPipelinesData, ListPipelinesErrors, ListPipelinesResponses, ListSensorsData, ListSensorsErrors, ListSensorsResponses, ListTenantsData, ListTenantsErrors, ListTenantsResponses, ListTracesData, ListTracesErrors, ListTracesResponses, ListWorkersData, ListWorkersErrors, ListWorkersResponses, ProcessUplinkDataData, ProcessUplinkDataErrors, ProcessUplinkDataResponses, QueryMeasurementsData, QueryMeasurementsErrors, QueryMeasurementsResponses, RemoveTenantMemberData, RemoveTenantMemberErrors, RemoveTenantMemberResponses, RevokeApiKeyData, RevokeApiKeyErrors, RevokeApiKeyResponses, UpdateDeviceData, UpdateDeviceErrors, UpdateDeviceResponses, UpdateFeatureOfInterestData, UpdateFeatureOfInterestErrors, UpdateFeatureOfInterestResponses, UpdatePipelineData, UpdatePipelineErrors, UpdatePipelineResponses, UpdateSensorData, UpdateSensorErrors, UpdateSensorResponses, UpdateTenantMemberData, UpdateTenantMemberErrors, UpdateTenantMemberResponses, UpdateWorkerData, UpdateWorkerErrors, UpdateWorkerResponses } from './types.gen';
...
export const listDevices = <ThrowOnError extends boolean = false>(options?: Options<ListDevicesData, ThrowOnError>) => {
    return (options?.client ?? client).get<ListDevicesResponses, ListDevicesErrors, ThrowOnError>({
        security: [
            {
                in: 'cookie',
                name: 'SID',
...
export const createDevice = <ThrowOnError extends boolean = false>(options?: Options<CreateDeviceData, ThrowOnError>) => {
    return (options?.client ?? client).post<CreateDeviceResponses, CreateDeviceErrors, ThrowOnError>({
        security: [
            {
                in: 'cookie',
                name: 'SID',
...
export const deleteDevice = <ThrowOnError extends boolean = false>(options: Options<DeleteDeviceData, ThrowOnError>) => {
    return (options.client ?? client).delete<DeleteDeviceResponses, DeleteDeviceErrors, ThrowOnError>({
        security: [
            {
                in: 'cookie',
                name: 'SID',
...
export const updateDevice = <ThrowOnError extends boolean = false>(options: Options<UpdateDeviceData, ThrowOnError>) => {
    return (options.client ?? client).patch<UpdateDeviceResponses, UpdateDeviceErrors, ThrowOnError>({
        security: [
            {
                in: 'cookie',
                name: 'SID',
...
export const listDeviceSensors = <ThrowOnError extends boolean = false>(options: Options<ListDeviceSensorsData, ThrowOnError>) => {
    return (options.client ?? client).get<ListDeviceSensorsResponses, ListDeviceSensorsErrors, ThrowOnError>({
        security: [
            {
                in: 'cookie',
                name: 'SID',
...
export const createDeviceSensor = <ThrowOnError extends boolean = false>(options: Options<CreateDeviceSensorData, ThrowOnError>) => {
    return (options.client ?? client).post<CreateDeviceSensorResponses, CreateDeviceSensorErrors, ThrowOnError>({
        security: [
            {
                in: 'cookie',
                name: 'SID',
...
export const deleteDeviceSensor = <ThrowOnError extends boolean = false>(options: Options<DeleteDeviceSensorData, ThrowOnError>) => {
    return (options.client ?? client).delete<DeleteDeviceSensorResponses, DeleteDeviceSensorErrors, ThrowOnError>({
        security: [
            {
                in: 'cookie',
                name: 'SID',
...
export const listSensors = <ThrowOnError extends boolean = false>(options?: Options<ListSensorsData, ThrowOnError>) => {
    return (options?.client ?? client).get<ListSensorsResponses, ListSensorsErrors, ThrowOnError>({
        security: [
            {
                in: 'cookie',
                name: 'SID',
...
export const listFeaturesOfInterest = <ThrowOnError extends boolean = false>(options?: Options<ListFeaturesOfInterestData, ThrowOnError>) => {
    return (options?.client ?? client).get<ListFeaturesOfInterestResponses, ListFeaturesOfInterestErrors, ThrowOnError>({
        security: [
            {
                in: 'cookie',
                name: 'SID',
...
export const createFeatureOfInterest = <ThrowOnError extends boolean = false>(options?: Options<CreateFeatureOfInterestData, ThrowOnError>) => {
    return (options?.client ?? client).post<CreateFeatureOfInterestResponses, CreateFeatureOfInterestErrors, ThrowOnError>({
        security: [
            {
                in: 'cookie',
                name: 'SID',
...
export const deleteFeatureOfInterest = <ThrowOnError extends boolean = false>(options: Options<DeleteFeatureOfInterestData, ThrowOnError>) => {
    return (options.client ?? client).delete<DeleteFeatureOfInterestResponses, DeleteFeatureOfInterestErrors, ThrowOnError>({
        security: [
            {
                in: 'cookie',
                name: 'SID',
...
export const getFeatureOfInterest = <ThrowOnError extends boolean = false>(options: Options<GetFeatureOfInterestData, ThrowOnError>) => {
    return (options.client ?? client).get<GetFeatureOfInterestResponses, GetFeatureOfInterestErrors, ThrowOnError>({
        security: [
            {
                in: 'cookie',
                name: 'SID',
...
export const updateFeatureOfInterest = <ThrowOnError extends boolean = false>(options: Options<UpdateFeatureOfInterestData, ThrowOnError>) => {
    return (options.client ?? client).patch<UpdateFeatureOfInterestResponses, UpdateFeatureOfInterestErrors, ThrowOnError>({
        security: [
            {
                in: 'cookie',
                name: 'SID',
...
export const queryMeasurements = <ThrowOnError extends boolean = false>(options: Options<QueryMeasurementsData, ThrowOnError>) => {
    return (options.client ?? client).get<QueryMeasurementsResponses, QueryMeasurementsErrors, ThrowOnError>({
        security: [
            {
                in: 'cookie',
                name: 'SID',
...
export const listDatastreams = <ThrowOnError extends boolean = false>(options?: Options<ListDatastreamsData, ThrowOnError>) => {
    return (options?.client ?? client).get<ListDatastreamsResponses, ListDatastreamsErrors, ThrowOnError>({
        security: [
            {
                in: 'cookie',
                name: 'SID',
...
export const getDatastream = <ThrowOnError extends boolean = false>(options: Options<GetDatastreamData, ThrowOnError>) => {
    return (options.client ?? client).get<GetDatastreamResponses, GetDatastreamErrors, ThrowOnError>({
        security: [
            {
                in: 'cookie',
                name: 'SID',
...
export const disablePipeline = <ThrowOnError extends boolean = false>(options: Options<DisablePipelineData, ThrowOnError>) => {
    return (options.client ?? client).delete<DisablePipelineResponses, DisablePipelineErrors, ThrowOnError>({
        security: [
            {
                in: 'cookie',
                name: 'SID',
...
export const updatePipeline = <ThrowOnError extends boolean = false>(options: Options<UpdatePipelineData, ThrowOnError>) => {
    return (options.client ?? client).patch<UpdatePipelineResponses, UpdatePipelineErrors, ThrowOnError>({
        security: [
            {
                in: 'cookie',
                name: 'SID',
...
export const processUplinkData = <ThrowOnError extends boolean = false>(options: Options<ProcessUplinkDataData, ThrowOnError>) => {
    return (options.client ?? client).post<ProcessUplinkDataResponses, ProcessUplinkDataErrors, ThrowOnError>({
        security: [
            {
                in: 'cookie',
                name: 'SID',
...
export const createWorker = <ThrowOnError extends boolean = false>(options?: Options<CreateWorkerData, ThrowOnError>) => {
    return (options?.client ?? client).post<CreateWorkerResponses, unknown, ThrowOnError>({
        security: [
            {
                in: 'cookie',
                name: 'SID',
...
export const updateWorker = <ThrowOnError extends boolean = false>(options: Options<UpdateWorkerData, ThrowOnError>) => {
    return (options.client ?? client).patch<UpdateWorkerResponses, UpdateWorkerErrors, ThrowOnError>({
        security: [
            {
                in: 'cookie',
                name: 'SID',
...
export const getWorkerUserCode = <ThrowOnError extends boolean = false>(options: Options<GetWorkerUserCodeData, ThrowOnError>) => {
    return (options.client ?? client).get<GetWorkerUserCodeResponses, GetWorkerUserCodeErrors, ThrowOnError>({
        security: [
            {
                in: 'cookie',
                name: 'SID',
...
export const listTenants = <ThrowOnError extends boolean = false>(options?: Options<ListTenantsData, ThrowOnError>) => {
    return (options?.client ?? client).get<ListTenantsResponses, ListTenantsErrors, ThrowOnError>({
        security: [
            {
                in: 'cookie',
                name: 'SID',
...
export const addTenantMember = <ThrowOnError extends boolean = false>(options: Options<AddTenantMemberData, ThrowOnError>) => {
    return (options.client ?? client).post<AddTenantMemberResponses, AddTenantMemberErrors, ThrowOnError>({
        security: [
            {
                in: 'cookie',
                name: 'SID',
...
export const removeTenantMember = <ThrowOnError extends boolean = false>(options: Options<RemoveTenantMemberData, ThrowOnError>) => {
    return (options.client ?? client).delete<RemoveTenantMemberResponses, RemoveTenantMemberErrors, ThrowOnError>({
        security: [
            {
                in: 'cookie',
                name: 'SID',
...
export const updateTenantMember = <ThrowOnError extends boolean = false>(options: Options<UpdateTenantMemberData, ThrowOnError>) => {
    return (options.client ?? client).patch<UpdateTenantMemberResponses, UpdateTenantMemberErrors, ThrowOnError>({
        security: [
            {
                in: 'cookie',
                name: 'SID',
