...
export type ListDevicesData = {
    ...
    query?: {
        ...
        id?: Array<number>;
        /**
         * Used to filter devices by their code.
         */
        code?: Array<string>;
        /**
...
export type ListFeaturesOfInterestData = {
    ...
    query?: {
        ...
        limit?: number;
        /**
         * Used to filter features by their name.
         */
        name?: Array<string>;
        /**
         * Used to filter features by its properties. This filters devices on whether their property contains the provided value. The value must be a JSON string and depending on your client should be URL Escaped
         */
        properties?: string;
    };
