...
func (ib *insertBuilder) SetLocation(id int64, name string, longitude, latitude float64) *insertBuilder {
...
func (ib *insertBuilder) SetCoordinates(longitude, latitude float64) *insertBuilder {
